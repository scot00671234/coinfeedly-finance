...
async function simpleSeed() {
  try {
    ...
    const sampleArticles: InsertArticle[] = [
      ...
      {
        title: "Dow Jones Reaches New Record High as Investors Celebrate Strong Earnings",
        content: "The Dow Jones Industrial Average closed at a record high today, driven by strong quarterly earnings reports from major corporations. Investors showed renewed confidence in the market's resilience and growth potential.",
        summary: "Dow Jones hits record high amid strong corporate earnings season.",
        category: "markets",
        authorName: "Robert Martinez",
        publishedAt: new Date(Date.now() - 28800000),
        featured: true,
        tags: ["dow-jones", "earnings", "record-high", "market-rally"],
        relatedSymbols: ["^DJI"],
        views: 3400,
        shares: 140,
      ...
      {
        title: "Oil Prices Surge 8% Following OPEC+ Production Cut Announcement",
        content: "Crude oil prices jumped sharply after OPEC+ announced unexpected production cuts totaling 1.2 million barrels per day. Energy stocks rallied across the board as investors anticipate tighter supply conditions.",
        summary: "Oil prices spike on OPEC+ production cuts, boosting energy sector.",
        category: "markets",
        authorName: "Jennifer Walsh",
        publishedAt: new Date(Date.now() - 32400000),
        featured: false,
        tags: ["oil-prices", "opec", "energy-sector", "commodities"],
        relatedSymbols: ["CL=F"],
        views: 2200,
        shares: 78,
      ...
      {
        title: "S&P 500 Volatility Spikes as Investors Weigh Inflation Data",
        content: "The S&P 500 experienced heightened volatility following the release of mixed inflation data. While some sectors showed resilience, technology stocks faced pressure from rising interest rate expectations.",
        summary: "S&P 500 volatility increases amid mixed inflation signals and rate concerns.",
        category: "markets",
        authorName: "Daniel Thompson",
        publishedAt: new Date(Date.now() - 36000000),
        featured: false,
        tags: ["sp500", "volatility", "inflation", "interest-rates"],
        relatedSymbols: ["^GSPC"],
        views: 1890,
        shares: 65,
      ...
      {
        title: "Ethereum Upgrades Successfully Complete, Network Efficiency Improves",
        content: "Ethereum's latest network upgrade has been successfully implemented, bringing significant improvements to transaction speed and energy efficiency. The upgrade is expected to reduce gas fees and enhance scalability.",
        summary: "Ethereum upgrade enhances network performance and reduces transaction costs.",
        category: "crypto",
      ...
      },
      {
        ...
        content: "A new decentralized finance protocol has launched an innovative lending platform that offers competitive rates and enhanced security features. The platform aims to democratize access to financial services.",
        summary: "New DeFi lending platform promises competitive rates and enhanced security.",
        category: "crypto",
        authorName: "Kevin Park",
        publishedAt: new Date(Date.now() - 43200000),
        featured: false,
        tags: ["defi", "lending", "protocol", "decentralized-finance"],
        relatedSymbols: [],
        views: 1750,
        shares: 92,
      ...
      {
        title: "Major Crypto Exchange Announces New Security Measures",
        content: "Following recent security concerns in the crypto industry, a leading exchange has implemented advanced security protocols including multi-signature wallets and enhanced user verification systems.",
        summary: "Crypto exchange enhances security with new protocols and verification systems.",
        category: "crypto",
        authorName: "Amanda Foster",
        publishedAt: new Date(Date.now() - 46800000),
        featured: false,
        tags: ["crypto-exchange", "security", "multi-signature", "verification"],
        relatedSymbols: [],
        views: 2100,
        shares: 88,
